LoadCheckoutPaymentContext(function (Checkout, PaymentOptions) {
    ...
    const payment_provider_ids = ["cda8e583-488e-407b-9806-2ef28f0f2f95","a47f165a-9b0c-447e-b023-37a7ebcd0a2b"];
    ...
    const PagarmeCreditCardPayment = new PaymentOptions.Transparent.CardPayment({
        ...
        onDataChange: Checkout.utils.throttle(async function () {
            ...
            currentCheckoutTotalPrice = await updateInstallmentsAndReturnTotalPrice(urlApp, methodConfig, Checkout, currentCheckoutTotalPrice);
        ...
        onSubmit: async function (callback) {
            ...
            const publicKey = await getPublickKey(urlApp, methodConfig.payment_provider_id);
    ...
    const PagarmeExternalPayment = new PaymentOptions.ExternalPayment({
        ...
        onSubmit: function (callback) {
            ...
            sendPaymentRequestAndCallbackForExternalPayment(urlApp, pagarmeOrder, methodConfig, callback);
        },
    });
